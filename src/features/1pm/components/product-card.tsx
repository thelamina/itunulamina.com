        ...
        <div className="relative flex shrink-0 items-center gap-3">
          ...
          {product.downloadUrl && (
            <a
              ...
              className="flex items-center justify-center border rounded-full size-8 text-xs font-semibold transition-all duration-300 hover:scale-[1.2]"
            >
          ...
          <Link
            href={product.url}
            className="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 text-neutral-400 transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:bg-neutral-900 group-hover:text-white dark:bg-neutral-800 dark:group-hover:bg-white dark:group-hover:text-neutral-900"
          >

    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <header className="flex min-h-[70vh] flex-col items-center justify-center px-6 text-center">
          ...
          >
            Annual letters to myself—on life, growth, faith, and the lessons
            that shaped each passing year.
          </motion.p>
        ...
        >
          <motion.div
            variants={item}
            className="mb-16 h-px bg-linear-to-r from-transparent via-(--eoy-accent) to-transparent opacity-30"
          />
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-(--eoy-border) bg-gradient-to-br from-white/[0.02] to-white/[0.01] p-8 backdrop-blur-sm transition-all duration-500 hover:border-[rgba(201,169,98,0.3)] hover:from-white/[0.04] hover:to-white/[0.02] md:p-12">
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="flex items-center gap-2 text-sm text-(--eoy-accent) transition-transform duration-300 group-hover:translate-x-2">
                          <span className="font-normal">Read reflection</span>
                          <ArrowRight size={16} />
                        </div>
                      </div>
                    </div>
          ...
          <motion.div
            variants={item}
            className="mt-16 h-px bg-linear-to-r from-transparent via-(--eoy-accent) to-transparent opacity-30"
          />

          <motion.footer variants={item} className="mt-16 text-center">
            <Link
              href="/"
